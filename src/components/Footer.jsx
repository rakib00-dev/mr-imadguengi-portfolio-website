const Footer = () => {
  return (
    <footer class="text-gray-400 bg-[#232222] body-font">
      <div class="max-w-7xl w-full container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
      ...
      <div class="bg-[#161515] bg-opacity-75">
        <div class="container max-w-7xl w-full mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
